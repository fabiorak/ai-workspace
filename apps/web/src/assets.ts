...
(() => {
  ...
  if (selectedProject) { importSection.hidden = false; searchSection.hidden = false; memorySection.hidden = false; workSection.hidden = false; instructionSection.hidden = false; text(importStatus, "A project is selected. You can import or re-import the safe sample."); loadMemory(); loadWork(); }
  applyLocale();
  loadProjects();
})();
`;
