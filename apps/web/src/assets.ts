...
(() => {
  ...
  if (selectedProject) { importSection.hidden = false; memorySection.hidden = false; workSection.hidden = false; instructionSection.hidden = false; text(importStatus, message("returningImport")); loadMemory(); loadWork(); }
  applyLocale();
  loadProjects();
})();
`;
