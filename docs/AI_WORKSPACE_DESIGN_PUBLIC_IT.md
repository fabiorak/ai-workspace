...
La visione oltre l'orizzonte corrente — moduli architetturali aggiuntivi, ADR
futuri, orizzonte di prodotto e workspace documentali — è conservata integra
nella [visione a lungo periodo](AI_WORKSPACE_VISION_LONG_TERM_IT.md). È stata
separata perché questo documento era diventato molto più grande della capacità
di consegna del progetto: chi legge deve poter distinguere ciò che viene
costruito da ciò che è soltanto immaginato.
...
## 30. Architettura tecnologica iniziale
...
## 33. Evoluzione della roadmap

La roadmap originale è stata consolidata nell'orizzonte di prodotto della
[visione a lungo periodo](AI_WORKSPACE_VISION_LONG_TERM_IT.md) e nella roadmap
operativa versionata del repository. La precedente
...
## 35. Struttura repository proposta
...
## 36. Decisioni architetturali iniziali
